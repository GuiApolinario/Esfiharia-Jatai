...
import { $, $$, dateTimeBR, escapeHtml, maskPhone, money, onlyDigits, parseMoney, shrinkImage, toast } from './utils.js?v=3';
import { isConfigured, SETUP_MESSAGE } from './supabase.js?v=3';
